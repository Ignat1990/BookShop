...
public class User implements UserDetails {
    ...
    public User(long id, String login, String username, String password, String passwordConfirm, String email, String mobile, Set<Role> roles, LocalDate registered_at) {
        this.id = id;
        this.login = login;
        this.username = username;
        this.password = password;
